...
var auth_helper_identity_server_1 = require("./auth-helper-identity-server");
...
function initIdentityServer(options) {
    return new Promise(function (resolve, reject) {
        try {
            if (exports.instance !== null) {
                reject("You already ran init");
            ...
            exports.instance = new auth_helper_identity_server_1.AuthHelperIdentityServer(options.clientId, options.scope, options.authority, options);
            resolve(exports.instance);
        }
        catch (ex) {
...
exports.initIdentityServer = initIdentityServer;
